// pages/Social.js — Refined Social Impact chapter
"use client";
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        setLoading(true);
        setError(null);
        const { products: list, warning } = await loadChapterProducts("social");
        if (cancelled) return;
        if (!list.length) {
          ...
          {loading ? (
            ...
            <>
              <header className="hero">
                <p className="eyebrow">Chapter · Social impact</p>
                <h1>Social Impact</h1>
                <p className="lead">
                  Healing out loud. Hope you can wear. Apparel that starts honest
                  conversations — and funds real support.
                </p>
                <div className="ctas">
              ...
              <div className="strip">
                <p>
                  Kindness in action. 10% of every sale supports mental health,
                  housing, and community healing.
                </p>
      ...
      <style jsx>{`
        ...
        .skyWash {
          ...
          background: linear-gradient(
            180deg,
            rgba(30, 41, 59, 0.52) 0%,
            rgba(30, 41, 59, 0.32) 28%,
            rgba(2, 6, 23, 0.82) 75%,
