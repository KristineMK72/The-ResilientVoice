    ...
    <main className="main">
      <section className="card about-card">
        ...
        <p className="about-text">
          ...
          heartbreak, and silent battle bexport default function Blog() {
  return (
    ...
    <main style={{ backgroundColor: '#f9f5f1', minHeight: '100vh' }}>
      ...
      {/* 2. Remove centering classes from the section, ensure it takes up space, 
          and prevent default margin/padding from centering content. */}
...
}ecame a reminder that even when life
          breaks us open, grace pours in.
        </p>
        <p className="about-text">
          This brand is more than apparel. It is a mission rooted in healing,
